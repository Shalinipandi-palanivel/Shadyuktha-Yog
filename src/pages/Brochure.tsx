...
const brochures = [
  {
    ...
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/hero-yoga.jpg",
    highlights: [
  ...
  return (
    <main className="pt-20">
      ...
      <section
        ...
        style={{
          backgroundImage: `url("https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/brochure.jpg")`,
