...
const programs = [
  ...
  //   { title: "Therapeutic Yoga (DPYT)", desc: "Evidence-based Dual-Phase Yoga Therapy model for chronic conditions and healing.", fee: "₹3,500/mo", image: therapeuticImg, path: "/programs/therapeutic-yoga", icon: Stethoscope, tag: "Healing" },
  //   { title: "Ashtanga Primary Series", desc: "Dynamic vinyasa flow building strength, discipline & traditional practice.", fee: "₹3,500/mo", image: ashtangaImg, path: "/programs/ashtanga", icon: Flame, tag: "Mastery" },
  //   { title: "Pranayama, Mudras & Bandhas", desc: "Master your energy through ancient breath science & subtle body practices.", fee: "₹3,500/mo", image: pranayamaImg, path: "/programs/pranayama", icon: Wind, tag: "Energy" },
  //   { title: "Kids Yoga: Glow & Grow", desc: "Fun, focused yoga for children aged 6-12 with story-flow asanas.", fee: "₹1,000/mo", image: kidsImg, path: "/programs/kids-yoga", icon: Baby, tag: "Kids" },
  //   { title: "Pre & Post Natal Yoga", desc: "Holistic maternity care for every trimester & postpartum recovery.", fee: "Contact Us", image: prenatalImg, path: "/programs/prenatal", icon: Heart, tag: "Maternity" },
];
