...
const specializedWorkshops = [
  {
    ...
    duration: "1 Day",
    hours: "2 Hours",
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/foundation-yoga.png",
  ...
  },
  {
    ...
    duration: "1 Day",
    hours: "2 Hours",
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/kriya-yoga.jpg",
  ...
  },
  {
    ...
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/backpain.jpg",
  ...
  },
  {
    ...
    duration: "1 Day",
    hours: "1 Hour and 30 Minutes",
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/stress.jpg",
    fee: { india: "₹1,500", international: "$60" },
    description: [
  ...
  },
  {
    ...
    duration: "1 Day",
    hours: "2 Hours",
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/awakening.png",
  ...
  },
  {
    ...
    duration: "1 Day",
    hours: "1.5 Hours",
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/Surynamaskar.png",
  ...
  return (
    <main className="pt-20">
      ...
      <section
        ...
        style={{ backgroundImage: `url("https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/workshop.png")` }}
      >
        ...
        <div className="container-fluid mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimateOnScroll animation="animate-slide-in-left">
              <img
                src="https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/corporate-yoga.jpg"
                alt="Corporate Yoga"
      ...
      <section className="section-padding bg-gradient-to-br from-secondary/40 via-background to-secondary/30">
        <div className="container-fluid mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src="https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/college-yoga.jpg"
                alt="College Yoga"
                className="rounded-3xl shadow-2xl w-full aspect-[4/3] object-cover"
              />
            </AnimateOnScroll>
