  ...
  1: {
    overview: (
      <div className="space-y-4">
        <p>
          Surya Namaskar (Sun Salutation) is a sequence of twelve yoga
          postures performed in a flowing rhythm synchronized with breath.
        </p>

        <p>
          It energizes the body, improves circulation, strengthens muscles,
          and enhances mental clarity. Traditionally practiced at sunrise,
          it symbolizes gratitude to the sun — the source of life and vitality.
        </p>
      </div>
    ),
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Builds internal heat that supports detoxification and endurance
...

    {
      ...
      content: (
        <ol className="list-decimal list-inside space-y-3">
          <li>Sit comfortably in a cross-legged position with a straight spine.</li>
          <li>Relax the shoulders and place the hands gently on the knees.</li>
          <li>
          ...
          <li>Continue breathing slowly and rhythmically for several minutes.</li>
        </ol>
      )
    },
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Beginners should practice slowly until familiar with the technique.
          </li>
        </ul>
      )
    }
  ...
  overview: (
    <div className="space-y-4">
      ...
      <p>
        ...
        <strong> Mula Bandha</strong>, or the root lock. Learning how to gently
        engage this area can help practitioners deepen their asana practice,
        prevent injuries, and develop greater body awareness.
      </p>
    </div>
  ),
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Improves core strength and stability, supporting safer movement
            in yoga poses and daily activities.
          </li>
          <li>
            Enhances spinal alignment and reduces strain on the lower back
            by creating a stable base for the spine.
          </li>
          <li>
            Increases control and awareness during yoga postures,
            particularly balancing poses and inversions.
          </li>
          <li>
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Combine pelvic floor exercises with core strengthening poses
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Progress gradually and prioritize mindful movement over
            intensity.
          </li>
        </ul>
      )
  ...
  overview: (
    <div className="space-y-4">
      <p>
        ...
        Patanjali, represents a holistic path toward self-realization and inner
        harmony. The word “Ashtanga” means “eight limbs,” referring to eight
        interconnected principles that guide an individual toward physical
        health, mental clarity, ethical living, and spiritual awakening.
      </p>
      ...
      content: (
        <ol className="list-decimal list-inside space-y-3">
          ...
          <li>
            ...
            self-study (Svadhyaya), and surrender to a higher reality
            (Ishvara Pranidhana).
          </li>

          <li>
            <strong>Asana</strong> – Physical postures that strengthen the body,
            improve flexibility, and prepare the practitioner for meditation.
          </li>

          <li>
            <strong>Pranayama</strong> – Breath control techniques that regulate
            life force energy (prana) and calm the nervous system.
          </li>
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Reduces stress and mental clutter through breathing and
            meditation practices.
          </li>
          <li>
            Improves focus, discipline, and emotional resilience.
          </li>
          <li>
            Cultivates deeper self-awareness and connection to life.
          </li>
        </ul>
      )
    },
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Maintain patience and consistency for steady progress.
          </li>
        </ul>
      )
    }
  ...
  overview: (
    <div className="space-y-4">
      <p>
        ...
        of computers. While technology improves productivity, prolonged sitting
        can place significant strain on the body. Desk workers frequently
        experience stiffness in the neck, shoulders, and lower back due to
        limited movement and poor posture.
      </p>
  ...
  sections: [
...

    {
      ...
      content: (
        <ol className="list-decimal list-inside space-y-3">
          <li>
            <strong>Seated Cat–Cow Stretch</strong> – Sit upright and alternate
            between arching and rounding your back to gently mobilize the
            spine.
          </li>
          <li>
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>Practice this routine every 2–3 hours during long work sessions.</li>
          <li>Maintain upright posture with relaxed shoulders.</li>
          <li>Combine yoga breaks with short walks for better circulation.</li>
          <li>Stay hydrated and avoid sitting continuously for long periods.</li>
  ...
  overview: (
    <div className="space-y-4">
      ...
      <p>
        ...
        flexibility, and builds emotional resilience while making movement
        fun and enjoyable for children.
      </p>
    </div>
  ),
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Encourages confidence and self-awareness through movement.
          </li>
          <li>
...

    {
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            <img
              src="/images/blog/butterfly-pose.jpg"
          ...
          <div className="space-y-3">
            <img
              src="/images/blog/warrior-pose.jpg"
              alt="Warrior Pose"
              className="w-full max-w-md rounded-xl shadow-md"
            />
            <p>
          ...
          <div className="space-y-3">
            <img
              src="/images/blog/balloon-breath.jpg"
              alt="Balloon Breathing"
              className="w-full max-w-md rounded-xl shadow-md"
            />
            <p>
              <strong>Balloon Breathing</strong> – A fun breathing exercise
              where children imagine inflating a balloon in their belly.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <img
              src="/images/blog/animal-walk.jpg"
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Provide positive encouragement to build confidence.
          </li>
          <li>
            Gradually increase session duration as children become comfortable.
          </li>
        </ul>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Focus on gentle movements and natural breathing.
          </li>
        </ul>
      )
    }
  ...
  overview: (
    <div className="space-y-4">
      ...
      <p>
        ...
        therapeutic yoga into daily life, individuals develop discipline,
        body awareness, and sustainable wellness habits that support
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Provides a personalized therapeutic approach tailored to individual
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            <strong>Phase 1 – Guided Therapy:</strong> A certified yoga therapist
            evaluates the individual's health condition and designs a
            personalized sequence of asanas, pranayama, and relaxation
            techniques.
          </li>

          <li>
            <strong>Phase 2 – Self Practice:</strong> The practitioner performs
            the prescribed routine independently at home on a regular basis.
          </li>
          ...
          <li>
            Periodic review sessions with the therapist help refine the therapy
            plan and ensure safe progress.
          </li>
        </ul>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Begin slowly and focus on proper breathing and alignment.
          </li>
          <li>
            Maintain consistency even if the daily practice is short.
          </li>
          <li>
  ...
  overview: (
    <div className="space-y-4">
      <p>
        ...
        Breathing, is a traditional yogic breathing technique designed
        to purify and balance the subtle energy channels of the body
        known as nadis.
      </p>

      <p>
        In yogic philosophy, the two main energy pathways — Ida and
        Pingala — represent the lunar and solar energies within the
        human system. When these energies are balanced, the mind becomes
        calm, focused, and emotionally stable.
      </p>

      <p>
        Through rhythmic breathing and gentle awareness, Nadi Shodhana
        harmonizes the nervous system, improves respiratory efficiency,
        and prepares the practitioner for meditation and deeper states
        of mindfulness.
      </p>
    </div>
  ),
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Helps reduce stress, anxiety, and mental agitation by calming
            the nervous system.
          </li>
          <li>
          ...
          <li>
            Prepares the mind for meditation and deeper mindfulness
            practices.
          </li>
          <li>
      ...
      content: (
        <ol className="list-decimal list-inside space-y-3">
          <li>
            ...
            with the spine upright and shoulders relaxed.
          </li>

          <li>
            Place your left hand on your knee and bring your right hand
            toward your nose in the Vishnu Mudra position.
          </li>

          <li>
            Close the right nostril gently with your thumb and inhale
            slowly through the left nostril.
          </li>

          <li>
            Close the left nostril using the ring finger, release the
            right nostril, and exhale through the right side.
          </li>

          <li>
            Inhale through the right nostril, then close it and exhale
            through the left nostril.
          </li>

          <li>
            This completes one cycle. Continue for 5–10 slow cycles
            while maintaining steady breathing and awareness.
          </li>
        </ol>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            Keep the breath slow, smooth, and rhythmic rather than
            forceful.
          </li>
          <li>
            Begin with 5 minutes daily and gradually increase the
            duration.
          </li>
          <li>
            Early morning or before meditation is considered the ideal
            time for practice.
          </li>
          <li>
            Maintain awareness of the breath and allow the mind to
            settle naturally.
          </li>
        </ul>
      )
...

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Avoid forcing or holding the breath if you feel discomfort
            or dizziness.
          </li>
          <li>
            People with severe respiratory conditions should consult a
          ...
          <li>
            Pregnant women should practice pranayama only under
  ...
  overview: (
    <div className="space-y-4">
      <p>
        ...
        strengthen the spine, and stimulate energy throughout the
        entire system. These poses counteract the forward-bending
        posture many people develop from long hours of sitting,
        working on computers, or using mobile devices.
      </p>

      <p>
        Understanding the anatomy of backbends helps practitioners
        perform them safely and effectively. When practiced with
        awareness, backbends engage the muscles of the back,
        shoulders, legs, and core while maintaining stability
        and protection for the spine.
      </p>

      <p>
        Rather than forcing flexibility in the lower back,
        effective backbend practice distributes extension
        evenly across the spine while opening the chest
        and strengthening supporting muscles.
      </p>
    </div>
  ),
  ...
  sections: [
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Improves spinal mobility and flexibility by encouraging
            balanced extension across the spine.
          </li>

          <li>
            Strengthens the back muscles, shoulders, and core,
            supporting better posture and stability.
          </li>

          <li>
            Opens the chest and rib cage, allowing deeper breathing
          ...
          <li>
            ...
            often improving mood and vitality.
          </li>
        </ul>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Begin with gentle warm-up poses such as Cat-Cow,
            Cobra Pose, and Bridge Pose to prepare the spine.
          </li>

          <li>
            Start with beginner backbends like Sphinx Pose
            or Baby Cobra before progressing deeper.
          </li>

          <li>
            Gradually explore intermediate poses such as
            Camel Pose (Ustrasana) or Bow Pose (Dhanurasana).
          </li>

          <li>
            Advanced poses like Wheel Pose (Urdhva Dhanurasana)
            should be practiced under proper guidance.
          </li>

          <li>
            Focus on breathing deeply and maintaining proper
            alignment rather than pushing into extreme depth.
          </li>
        </ul>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Engage the core and legs to support the lower
            back during backbend movements.
          </li>

          <li>
            Focus on lifting the chest and lengthening
            the spine rather than compressing the lumbar area.
          </li>

          <li>
            Use props like yoga blocks, bolsters,
            or straps for safer progression.
          </li>

          <li>
            Move slowly and mindfully when entering
            and exiting backbend poses.
          </li>

          <li>
            Balance backbend practice with forward folds
            or gentle twists afterward.
          </li>
        </ul>
      )
    },

    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-3">
          <li>
            Avoid deep backbends if you have severe lower
            back, neck, or spinal injuries.
          </li>

          <li>
            Always warm up the body before attempting
            deeper backbend postures.
          </li>

          <li>
            Do not force flexibility — allow the body
            to progress gradually over time.
          </li>

          <li>
            If you feel sharp pain or compression in
            the lower back, gently come out of the pose.
          </li>

          <li>
            Seek guidance from a qualified yoga
            instructor when learning advanced backbends.
          </li>
        </ul>
      )
    }
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 max-w-7xl mx-auto">
  ...
  <button
    ...
    className="mt-5 text-sm inline-flex justify-center items-center gap-2 px-4 py-2 text-primary rounded-full hover:bg-white hover:text-accent transition-all"
  >
  <button
  onClick={() => setSelectedPost(post)}
  className="text-sm inline-flex items-center gap-2 px-4 py-2 text-primary rounded-full hover:bg-white hover:text-accent transition-all"
>
  READ ARTICLE →
...
{selectedPost && (
  ...
  >
    <motion.div
      ...
      className="relative w-[95%] max-w-6xl max-h-[95vh] overflow-y-auto bg-white rounded-3xl shadow-2xl border border-gray-200"
      style={{
    ...
    >
      ...
      >
        <img
          ...
          className="w-full h-[420px] object-cover rounded-t-3xl shadow-lg"
        />
        <div className="absolute bottom-6 left-10 bg-white/80 backdrop-blur px-5 py-3 rounded-xl shadow">
          <p className="text-sm text-gray-600">{selectedPost.date}</p>
        </div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto px-10 py-16 text-center">
        ...
        <motion.h1
          ...
          className="text-5xl font-serif mb-12 text-gray-800"
        >
          {selectedPost.title}
        </motion.h1>
        ...
        {/* Sections */}
        {fullContent[selectedPost.id]?.sections?.map((section, i) => (
          <motion.div
            key={i}
  ...
  <div className="relative flex flex-col md:flex-row items-center justify-between gap-10 mb-16">
    {/* Left: Title + Content */}
    <motion.div
    ...
    <motion.img
      ...
      animate={{ x: 0, opacity: 1 }}
      transition={{ duration: 0.7 }}
      className="flex-1 w-full max-w-[320px] h-[320px] object-cover rounded-xl shadow-lg hover:scale-105 transition"
    />
  </div>
): (
        ...
        <motion.div
          ...
          className="mt-20 text-center bg-gradient-to-r from-primary/90 to-primary p-12 rounded-3xl shadow-xl"
        >
          ...
          <p className="text-lg text-white max-w-2xl mx-auto mb-8">
            Struggling with alignment, breathing, or consistency?
            Join personalized yoga sessions and experience transformation
    ...
    "Hello! I want to know more about your yoga programs."
            ...
            bg-white text-primary rounded-full shadow-lg
