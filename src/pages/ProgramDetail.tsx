...
interface ProgramBase {
  ...
  sessionType?: string[];
  sessionTypeonline?: string[];
  sessionTypeoffline?: string[];
...
> = {
  "ycb-level-1": {
    ...
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/YCB1.mp4",
    fee: "₹10,999",
    duration: "2 Months",
  ...
  "ycb-level-2": {
    ...
    tagline: "Align • Awaken • Ascend",
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/YCB2.mp4",
    fee: "₹12,999",
    duration: "2 Months",
    mode: "Online Live Classes",
    frequency: "Monday – Friday",
  ...
  "ycb-level-3": {
    ...
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/YCB3.mp4",
    fee: "₹14,999",
    duration: "2 Months",
    mode: "Online Live Classes",
    frequency: "Monday – Friday",
  ...
  "therapeutic-yoga": {
    ...
    extra: {
      ...
      sessionTypesoffline: [
        {
          type: "One-on-One Private Therapy",
          ideal: "Personalized in-home session for tailored guidance and care",
          fee: "₹1,999/session",
        },
        {
          type: "Semi-Private Group (Max 3)",
          ideal:
            "Personalized in-home session for tailored guidance and care for group",
          fee: "₹1,399/session",
        },
      ],
    },
  ...
  pranayama: {
    ...
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/meditation.mp4",
    fee: "₹3,500/month",
    duration: "60 minutes",
    mode: "Live Online",
    frequency: "5 days per week",
  ...
  "kids-yoga": {
    ...
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/kids-yoga.mp4",
    fee: "₹1,000/month",
    duration: "60 minutes",
    mode: "Live Online",
  ...
  "intermediate-yoga": {
    ...
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/intermediate-yoga.jpg",
  ...
  "beginner-yoga": {
    ...
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/beginner-yoga.jpg",
    // video: beginnerVideo,
    fee: "₹3,000 / month",
    duration: "60 minutes",
    mode: "Live Online Guided Sessions",
  ...
  "advanced-yoga": {
    ...
    image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/advanced.jpg",
    fee: "₹5,500 / month",
  ...
  prenatal: {
    ...
    video: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/videos/prenatal-yoga.mp4",
    fee: "₹4,000/month",
    duration: "60 minutes",
    mode: "Live Online",
    ...
    extra: {
      sessionTypesoffline: [
        {
          type: "One-on-One Private Classes",
          ideal: "Personalized in-home session for tailored guidance and care",
          fee: "₹1,999/session",
        },
        {
...
const YCBLayout = ({
  ...
  return (
    <>
      ...
      <section className="py-16 bg-background">
        ...
        <p className="container-fluid text-center text-primary  font-semibold leading-relaxed px-6 md:px-0 max-w-8xl">
          {program.description}
        </p>
      </section>

      {/* Exam & Fee Structure */}
      <section className="py-16 bg-gradient-to-r from-primary/40 via-background/40 to-primary/40 container-fluid mx-auto max-w-7xl space-y-12 rounded-3xl p-8">
        <AnimateOnScroll>
      ...
      {/* Schedule Section */}
      <section className="py-16 bg-background container-fluid mx-auto max-w-6xl md:max-w-4xl">
        <div className="bg-gradient-to-r from-primary/40 via-background/40 to-primary/40 rounded-lg p-6 border border-border shadow-md mx-auto">
          <h2 className="font-serif text-3xl md:text-xl font-bold text-primary mb-5 text-center">
            Program Schedule
          </h2>
  ...
  {slug === "ycb-level-1" ? (
    program.timing.map((t, i) => (
      <div
        key={i}
        className="flex items-center gap-2 w-60 md:w-80 " 
      >
        <Clock className="w-4 h-4 text-primary shrink-0" />
        <span className="text-foreground">{t}</span>
      </div>
    ...
    program.timing.map((time, index) => (
      <div
        key={index}
        className="flex items-center gap-2 w-40" // same width
      >
        <Clock className="w-4 h-4 text-primary shrink-0" />
      ...
      <section className="mx-auto space-y-16">
        <section className="py-24 bg-gradient-to-b from-primary/10 via-background to-primary/10 relative overflow-hidden">
          <div className="container-fluid mx-auto max-w-7xl px-6">
            <AnimateOnScroll>
        ...
        <section className="bg-background relative overflow-hidden">
          <div className="container-fluid mx-auto max-w-3xl px-6">
            <AnimateOnScroll>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary mb-10 text-center">
    ...
    <>
      ...
      <section className="relative w-full h-[100vh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="container-fluid mx-auto px-4 text-center max-w-8xl">
            <AnimateOnScroll>
              {/* Back */}
              <Link
                to="/"
      ...
      <section className="section-padding">
        ...
        {extra?.philosophy && (
          <section className="relative w-full flex justify-center mt-20">
            <AnimateOnScroll>
              <div className="max-w-8xl w-full text-center rounded-3xl bg-gradient-to-br from-primary/90 via-primary to-primary/80 text-white px-8 py-14 shadow-2xl border border-white/20">
                {/* Title */}
...
const TherapeuticLayout = ({
  ...
  const extra = program.extra as {
    ...
    sessionTypesonline: { type: string; ideal: string; fee: string }[];
    sessionTypesoffline: { type: string; ideal: string; fee: string }[];
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(
        "https://backend.shadyukthayog.com/api/therapy",
        formData,
      );
  ...
  <img
    className="absolute inset-0 w-full h-full object-cover"
    src={program.image}   // 🔁 add image field in program object
    alt={program.title}
  />
  ...
  {/* Content */}
  <div className="relative z-10 flex items-center justify-center h-full">
    <div className="mx-auto px-4 text-center max-w-8xl">
      <AnimateOnScroll>
        {/* Back Button */}
        <Link
          to="/"
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <AnimateOnScroll>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {extra.sessionTypesonline.map((s) => (
                    <div
                      key={s.type}
              ...
              {/* Session Types -Offline */}
              <AnimateOnScroll>
                <h2 className="font-serif text-2xl font-bold text-foreground mb-6">
                  Session Types - OFFLINE
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {extra.sessionTypesoffline.map((s) => (
                    <div
                      key={s.type}
                      className="bg-card rounded-2xl border border-border p-6 text-center hover-lift"
                    >
          ...
          <section id="therapy-intake-form" className="bg-secondary/20">
            <div className="mx-auto max-w-6xl">
              ...
              <form
                ...
                className="w-full max-w-8xl mx-auto space-y-12 bg-background/60 backdrop-blur-xl border border-border rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-xl"
              >
                {/* 1. Personal Details */}
                ...
                <div className=" flex flex-col items-center">
                  <button
                    type="submit"
                    className="px-6 py-3 rounded-2xl bg-primary text-primary-foreground font-semibold tracking-wide shadow-lg hover:scale-105 transition"
                  >
                    Submit Intake Form
                  </button>
                </div>
...
const MindBodyLayout = ({
  ...
  return (
    <>
      ...
      <section className="section-padding">
        <div className="flex justify-center">
          <AnimateOnScroll className="max-w-8xl text-center">
            {/* Heading */}
  ...
  return (
    <>
      <section className="relative w-full h-[80vh] overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="container-fluid mx-auto px-4 max-w-8xl text-center">
            <AnimateOnScroll>
              {/* Back Button */}
              <Link
                to="/"
    ...
    <>
      ...
      <section className="">
        <section className="relative w-full min-h-[70vh] flex items-center justify-center">
          <div className="container-fluid mx-auto px-4 max-w-3xl text-center">
            <AnimateOnScroll>
              {/* Title */}
        ...
        <div className="container-fluid mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              ...
              <AnimateOnScroll>
                <h2 className="font-serif text-2xl font-bold text-foreground mb-6">
                  Moments from Kids Yoga
                </h2>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
                  {["https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/Butterfly-aditya.png", "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/plank-dhanvi.png"].map((img, i) => (
                    <div
                      key={i}
                    ...
                    >
                      <img
                        src={img}
                        alt="Kids Yoga Activity"
                        className="w-full h-[360px] object-cover hover:scale-105 transition duration-300"
                      />
                    </div>
                  ))}
                </div>
