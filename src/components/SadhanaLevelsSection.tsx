...
const SadhanaLevelsSection = () => {
  const levels = [
    ...
    },
    {
      ...
      image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/advanced-yoga.jpg",
  ...
  const practiceFormats = [
    {
      ...
      image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/structured-program.jpg",
      shortDesc:
    ...
    },
    {
      ...
      image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/regular-practice.jpg",
      shortDesc:
    ...
    },
    {
      ...
      image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/daily-practice.jpg",
      shortDesc:
...
<div className="text-center mt-20">
  <Link
    to="/allprograms"
    className="flex items-center justify-center px-12 py-6 text-lg rounded-full bg-primary text-white hover:bg-primary/90 transition-colors w-[320px] mx-auto"
  >
    View All Programs
