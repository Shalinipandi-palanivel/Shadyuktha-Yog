...
const ProgramsCardSection = () => {
  const programs = [
    ...
    },
    {
      ...
      fee: "Contact Us",
      image: "https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/college-yoga.jpg",
      path: "/workshops",
      icon: Sparkles,
      tag: "Workshop",
  ...
  to-transparent"
          />
          <img
            src="https://shadyukthayoga.s3.ap-south-1.amazonaws.com/assets/regular-practice.jpg"
            alt="Hero Background"
        ...
        <div className="container relative z-20 px-4 md:px-6 flex justify-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-green/100 my-8 max-w-xl mx-auto">
      ...
      <div className="container-fluid mx-auto mt-10 px-2 relative z-10">
        {/* Header */}
    ...
    overflow-hidden shadow-sm hover:shadow-lg transition-all duration-700`}
      ...
      group-hover:scale-110 transition-transform duration-&lsqb; 1200ms&rsqb; ease-out"
                      />
                    </div>
                  </div>
