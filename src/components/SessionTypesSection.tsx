        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <AnimateOnScroll animation="animate-slide-in-left">
            <div className="bg-card rounded-3xl border-2 border-primary/20 p-10 text-center hover-lift h-full">
              ...
              <Link to="/Shadyuktha-Yog/pricing" className="gradient-green text-primary-foreground px-6 py-2.5 rounded-full text-sm font-semibold inline-flex items-center gap-2 hover:opacity-90 transition-opacity">
